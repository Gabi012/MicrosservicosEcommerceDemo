...
namespace AuthenticationApi.Infraestructure.Repositories
{
    public class UserRepository(AutheticationDbContext context, IConfiguration config) : IUser
    {
        ...
        public async Task<Response> Login(LoginDTO loginDTO)
        {
            ...
            if (getUser is null)
                return new Response(false,"Invalidy credencials.");
        ...
        public async Task<Response> Register(AppUserDTO appUserDTO)
        {
            ...
            if (getUser is not null)
                return new Response(false, "you cannot user this email for registration.");
